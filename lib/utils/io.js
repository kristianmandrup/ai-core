...
const readJson = function(filePath) {
  return global.mockedFiles ? global.mockedFiles[filePath] : jsonfile.readFileSync(filePath);
}

const writeJson = function(filePath, data) {
  return global.mockedFiles ? global.mockedFiles[filePath] = data : jsonfile.writeFileSync(filePath, data);
}
